...
import { 
  ...
  Settings, LogOut, Search, Bell, Droplets, X
} from 'lucide-react';
      ...
      <header className="h-[72px] bg-white border-b border-slate-200 flex items-center justify-between px-6 shrink-0 z-20">
        ...
        <div className="flex items-center gap-5 ml-4">
                ...
                {notifications.length > 0 && (
                  <div className="border-t border-slate-100 p-2">
                    <button 
                      ...
                      className="w-full text-center text-xs font-semibold text-[#1b2b4d] py-2 hover:bg-slate-50 rounded"
                    >
                      Clear All
                    </button>
                  </div>
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            <img 
              src={`https://ui-avatars.com/api/?name=${user?.name || 'John Williams'}&background=e2e8f0&color=1e293b`} 
              alt="User" 
